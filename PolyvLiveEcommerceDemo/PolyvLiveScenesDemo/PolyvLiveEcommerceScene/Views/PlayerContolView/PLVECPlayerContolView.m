...
- (void)layoutSubviews {
    ...
    self.currentTimeLabel.frame = CGRectMake(CGRectGetMaxX(self.playButton.frame)+10, originY+4, 41, 12);
    self.totalTimeLabel.frame = CGRectMake(CGRectGetWidth(self.bounds)-41, originY+4, 41, 12);
