...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [PLVECUtils drawViewCornerRadius:self size:frame.size cornerRadii:CGSizeMake(10.0, 10.0) corners:UIRectCornerTopLeft|UIRectCornerTopRight];
        
        self.closeButton = [UIButton buttonWithType:UIButtonTypeCustom];
        self.closeButton.frame = CGRectMake(CGRectGetWidth(frame)-36, 15, 28.0, 28.0);
